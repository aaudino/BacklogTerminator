...
export declare class HowLongToBeatEntry {
    ...
    constructor(id: string, name: string, description: string, platforms: string[], imageUrl: string, timeLabels: Array<string[]>, gameplayMain: number, gameplayMainExtra: number, gameplayCompletionist: number, similarity: number, searchTerm: string, genre?: string[], rating?: number);
}
/**
